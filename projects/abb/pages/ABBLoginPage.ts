...
/**
 * Page Object Model for ABB Login Page
 */
export class ABBLoginPage {
  private page: Page;
  ...
  async waitForLoad() {
    await this.loginForm.waitFor({ timeout: TIMEOUTS.API_RESPONSE });
  }
  ...
  async isLoginSuccessful(): Promise<boolean> {
    try {
      await this.page.waitForURL('**/dashboard', { timeout: TIMEOUTS.API_RESPONSE });
      return true;
    } catch {
      return false;
    }
